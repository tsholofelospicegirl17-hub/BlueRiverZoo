<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="Staff.CustomerLogin" %>
<!DOCTYPE html>
...
<form id="form1" runat="server">
    ...
    <div class="card">
        ...
        <div class="links">
            <a href="Signup.aspx">Sign Up</a> | <a href="ForgotPassword.aspx">Forgot Password?</a>
        </div>
    </div>
</form>
</body>
